 ...
 */
case class LineShape(p1 : Vector, p2 : Vector, attributes : Attributes) extends BasicShape
{

  val end = p2

  val geometry = new Segment(p1, p2)
...
object LineShape
{
  def apply(p1 : Vector, p2 : Vector)                    = new LineShape(p1, p2, Attributes())

  def fromSegment(line : Segment) = LineShape(line.p1, line.p2)
