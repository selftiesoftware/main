  ...
  SIIGNA MAINLINE
  the mainline of Siigna is the core of the software. It generates the application window, creates the ability to draw, 
  and send messages. On top of mainline lies the MODULES, which contain specific drawing tools.
  The mainline facilitates a system for sending commands via messages, allowing entire drawings of parts of drawings 
  to be send dynamically and viewed on other instances of Siigna in real time.
